...
{
    Serial.begin(57600);
    DateTime.sync(0); // inicia o relogio
}
...
int seconds = numberOfSeconds(val);
 ...
 // exibição do relógio digital da hora atual
...
void printDigits(byte digits){
 // função de utilidade para exibição do relógio digital: imprime dois pontos e leva 0
 Serial.print(":");
 if(digits < 10)
   Serial.print('0');
